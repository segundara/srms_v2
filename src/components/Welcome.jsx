...
class JumBotron extends React.Component {
    render() {
        return (
            // <Jumbotron fluid className="shadow-lg" style={{ backgroundColor: '#343a40', border: 2 + 'px solid #6351ce' }}>
            //     <div>
            //         <Image src="/road_to_knowledge.png" className="img-fluid" alt="Road_To_Knowledge image" />
            //     </div>
            // </Jumbotron>
